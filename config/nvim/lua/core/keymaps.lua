...
-- Trouble
vim.keymap.set('n', '<leader>tt', '<cmd>Trouble todo toggle<cr>', { desc = '[t]odo' })
vim.keymap.set('n', '<leader>td', '<cmd>Trouble diagnostics toggle<cr>', { desc = '[d]iagnostics' })
vim.keymap.set('n', '<leader>tb', '<cmd>Trouble diagnostics toggle filter.buf=0<cr>', { desc = '[b]uffer' })
vim.keymap.set('n', '<leader>ts', '<cmd>Trouble symbols toggle focus=false<cr>', { desc = '[s]ymbols' })
vim.keymap.set('n', '<leader>tl', '<cmd>Trouble lsp toggle focus=false win.position=right<cr>', { desc = '[L]SP Definitions / references / ...' })
vim.keymap.set('n', '<leader>to', '<cmd>Trouble loclist toggle<cr>', { desc = 'l[o]ocation' })
vim.keymap.set('n', '<leader>tq', '<cmd>Trouble qflist toggle<cr>', { desc = '[q]uickfix' })
...
vim.keymap.set({ 'n', 'v', 'o' }, 'h', '<Nop>', { noremap = true })
vim.keymap.set({ 'n', 'v', 'o' }, 'j', '<Nop>', { noremap = true })
vim.keymap.set({ 'n', 'v', 'o' }, 'k', '<Nop>', { noremap = true })
